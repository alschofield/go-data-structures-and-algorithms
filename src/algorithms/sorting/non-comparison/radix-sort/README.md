...
## Contract
Use stable per-digit counting sorts in LSD order and reuse auxiliary storage where practical. Allocation failure preserves input. Do not compare keys or call `sort`.
