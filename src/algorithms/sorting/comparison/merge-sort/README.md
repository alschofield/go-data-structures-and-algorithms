...
## Contract
Sort ascending and stably. Success returns `(true, nil)`. A nil comparator
returns `(false, ErrNilComparator)` without changing input. Handle empty,
singleton, and uneven halves. Do not call `sort`.
